...
// function to find the top 5 players with field goals over 40 yards 
$sql = "SELECT `playerid`,players.name,players_stats.season,yards as rushyards 
        FROM `players_stats` 
        LEFT JOIN players on players_stats.playerid = players.id 
        GROUP BY `playerid`, season 
        ORDER BY rushyards desc, `season` LIMIT 5";
